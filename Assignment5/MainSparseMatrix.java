...
public class MainSparseMatrix {
	...
	public static Map<Key , Integer> createSparseMatrix1(int noOfRowS , int noOfColumns ,int noOfElements ){
	...
	public static void main(String []args){
		...
		Map<Key , Integer> tempSparseMatrix = createSparseMatrix1(noOfRows, noOfColumns, noOfElements);
		...
		Map<Key , Integer> tempSparseMatrix2 = createSparseMatrix1(noOfRows2, noOfColumns2, noOfElements2);
		...
		Map<Key , Integer> tempSparseMatrix3 = createSparseMatrix1(noOfRows3, noOfColumns3, noOfElements3);
